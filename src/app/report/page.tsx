  ...
  if (!report) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-16">
        ...
        <p className="text-sm text-muted">Could not generate report. Make sure GROQ_API_KEY is set in Vercel environment variables.</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <header className="mb-10 border-b border-border pb-8">
        ...
        <h1 className="font-serif text-4xl font-bold leading-tight mb-4">{report.headline}</h1>
      ...
      <nav className="mb-10 border border-border p-4">
        <p className="text-xs font-semibold uppercase tracking-wider text-muted mb-3">In This Report</p>
